...
def collect_activations():
    ...
    print("last_layer_activations shape:", last_layer_activations.shape)
    print("second_to_last_layer_activations shape:", second_to_last_layer_activations.shape)
    print("last_layer_labels shape:", last_layer_labels.shape)
...
# last_layer_activations shape: torch.Size([24960, 512])
# second_to_last_layer_activations shape: torch.Size([24960, 2048])
# last_layer_labels shape: torch.Size([24960])
# data_points shape: torch.Size([24960, 3, 32, 32])
